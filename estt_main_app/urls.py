...
urlpatterns = [
    ...
    path('team/<int:team_id>/game/<int:game_id>/target-times/', views.view_target_times, name='view-target-times'),
    path('team/<int:team_id>/game/<int:game_id>/target-times/create/', views.create_target_times, name='create-target-times'),
    path('team/<int:team_id>/game/<int:game_id>/diamond-times/upload/', views.upload_diamond_times, name='upload-diamond-times'),
