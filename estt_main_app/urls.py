...
urlpatterns = [
    ...
    path('team/<int:team_id>/game/<int:game_id>/target-times/delete/<int:level_id>/', views.delete_target_times, name='delete-target-times'),
    path('team/<int:team_id>/game/<int:game_id>/target-times/diamond-times/delete/<int:level_id>/', views.delete_diamond_times, name='delete-diamond-times'),
