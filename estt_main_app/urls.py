...
urlpatterns = [
    ...
    path('team/<int:teamID>/target-times/<int:game_id>/', views.view_target_times, name='view-target-times'),
    path('team/<int:teamID>/target-times/', views.view_target_times, name='view-target-times'),
    path('team/<int:teamID>/target-times/create/', views.create_target_times, name='create-target-times'),
    path('team/<int:teamID>/target-times/<int:game_id>/delete/<int:level_id>/', views.delete_target_times, name='delete-target-times'),
    path('team/<int:teamID>/diamond-times/<int:game_id>/delete/<int:level_id>/', views.delete_diamond_times, name='delete-diamond-times'),
    path('team/<int:teamID>/diamond-times/upload/', views.upload_diamond_times, name='upload-diamond-times'),
    ...
    path('api/target-times/<int:teamID>/<int:game_id>/', views.get_target_times, name='get-target-times'),
